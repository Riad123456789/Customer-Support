...
const FetchDataPromise = fetch('./public/FackData.json')
.then(res => res.json())
...
const AllCustomer = () => {
  return (
    <div className='bg-gray-200'>
      <div className='max-w-7xl mx-auto flex justify-between gap-4 py-13'>
        ...
        <div className='flex-1 h-96 bg-amber-200'>c</div>
      </div>
    </div>
  )
}
